...
public class MovePointHeightInput : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            lastPosition = new Vector3(0, rightController.transform.position.y, 0);
        }
        else if (controllerEvents.gripPressed)
        {
            ...
            {
                float diff = curPos.y - lastPosition.y;
                EventBroker.CallSetPointHeightData(diff);
                lastPosition = curPos;
            }
        }
    }
